...
#define T_EVNT2 3 // Période de gestion pour le rafraîchissement des valeur deu capteur BME680
#define T_EVNT3 1// Affichage(date,heure...) toute les secondes
...
void loop() 
{
  ...
  {
    //Serial.println("entre dans event2");
